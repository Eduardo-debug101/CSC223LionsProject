...
class LinkedListStore {
    ...
    class Node {
         ...
         * Constructor.
         *
         * @param Customer The element to be stored in the node.
         * @param n        The reference to the successor node.
         * @param p        The reference to the predecessor node.
         */

        Node(CustomerCreator customerCreator, Node n, Node p) {
            value = customerCreator;
            next = n;
            prev = p;
        }
        ...
        Node(CustomerCreator customerCreator) {
            // Just call the other (sister) constructor
            this(customerCreator, null, null);
        }
    }
     ...
     *
     * @param Customer The value to add.
     */
