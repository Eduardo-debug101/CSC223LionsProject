...
public class Customer {
	...
	public void setCustomerNotes() {
		String notes = null;
		if (waitTime == 0) {
			notes = " Goes to " + assignedQueueLetter + " @ " + arrivalTime + "; leaves @ " + finishTime + "; WAIT: " + waitTime;
		} else {
			notes = " Goes to " + assignedQueueLetter + " @ " + arrivalTime + "; Service starts @ "
					+ (arrivalTime + serviceTime) + "; leaves @ " + finishTime + "; WAIT: " + waitTime;
		}
